...
class WeatherCrawlerApp(QWidget):
    ...
    def __init__(self):
        ...
        self.setGeometry(200, 200, 450, 580)  # Increased height for new field
    ...
    def initUI(self):
        ...
        self.resize(self.width(), 580)  # Adjusted height
    # --- END MODIFIED initUI ---
    ...
    # ... (Keep generate_vietnamese_weather_report_action) ...
